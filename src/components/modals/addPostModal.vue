<template>
  ...
  />
  <div
    class="addPostModal fixed bg-white h-4/5 z-30 top-28 px-7 py-14 sm:p-14 left-0 right-0 sm:left-10 sm:right-10 md:w-4/5 md:m-auto lg:w-2/3 font-glight overflow-y-auto"
  >
    <span
      @click="$emit('closeModal')"
